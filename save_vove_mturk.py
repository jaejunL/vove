...
if __name__ == "__main__":
    ...
    wav_root = "/disk2/LRS3/modified/vove/wer_sifted"
    ...
    for i, wav_dir in enumerate(wav_dirs):
        ...
        save_dir = wav_dir.replace('/wer_sifted/',f'/vovefull10/').replace('.wav', '.npy')
...
# 25.02.19
# CUDA_VISIBLE_DEVICES=0 python save_vove_mturk.py --exp_name=voveveve --ckpt=10